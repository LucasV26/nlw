...
interface OrphanageMapMarkerRouteParms {
  position: {
    latitude: number;
    longitude: number;
  }
...
export default function OrphanageData() {
  ...
  const params = route.params as OrphanageMapMarkerRouteParms;
  ...
  async function handleSelectImages() {
    ...
    if(status !== 'granted'){
      alert('Você precisa liberar o acesso à galeria para selecionarmos uma foto.');
      return;
    }

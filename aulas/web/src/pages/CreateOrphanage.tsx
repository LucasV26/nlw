...
export default function CreateOrphanage() {
  ...
  // Criar um state de React para cada campo necessitado
  ...
  async function handleSubmit(event: FormEvent) {
    event.preventDefault(); // Necessário para que a página não recarregue ao dar submit
